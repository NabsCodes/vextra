        ...
        <div className="flex min-h-[calc(100vh-72px)] flex-col justify-center py-12 pb-24">
          ...
          <h1 className="font-display text-charcoal-grey text-[12vw] leading-[0.9] font-semibold tracking-tight md:text-[9vw] lg:text-[7vw]">
            <motion.span
              ...
              className="block"
            >
              {homePageContent.hero.headline.opening}
            </motion.span>
            <motion.span
              initial={{ opacity: 0, y: 40 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              {homePageContent.hero.headline.highlight}
            </motion.span>
            <motion.span
              initial={{ opacity: 0, y: 40 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              className="block"
            >
              {homePageContent.hero.headline.closing}
            </motion.span>
          </h1>
          ...
          >
            {homePageContent.hero.services.map((label, index) => (
